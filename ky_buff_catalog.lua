...
KH.BUFF_MAP = {
    ...
    lock_n_load = { skill_id = "shock_and_awe", skills_new = { 3, 0 }, category = "technician", value_format = "multiplier_percent", default_show = true },

    second_wind = { skill_id = "scavenger", skills_new = { 4, 1 }, category = "ghost", value_format = "multiplier_percent", default_show = true },
    unseen_strike = { skill_id = "unseen_strike", skills_new = { 4, 5 }, category = "ghost", default_show = true },
    sixth_sense = { skill_id = "chameleon", skills_new = { 4, 7 }, category = "ghost", show_stack_count = true, default_show = true },
    dire_need = { skill_id = "dire_need", skills_new = { 4, 8 }, category = "ghost", default_show = true },

    berserker = { skill_id = "wolverine", skills_new = { 5, 0 }, category = "fugitive", value_format = "percent", default_show = true },
    swan_song = { skill_id = "perseverance", skills_new = { 5, 3 }, category = "fugitive", default_show = false },
    trigger_happy = { skill_id = "trigger_happy", skills_new = { 5, 4 }, category = "fugitive", value_format = "multiplier_percent", show_stack_count = true, default_show = false },
    desperado = { skill_id = "expert_handling", skills_new = { 5, 5 }, category = "fugitive", default_show = true },
    bloodthirst_basic = { skill_id = "bloodthirst", skills_new = { 5, 6 }, category = "fugitive", value_format = "multiplier", show_stack_count = true, default_show = false },
    bloodthirst_aced = { skill_id = "bloodthirst", skills_new = { 5, 6 }, category = "fugitive", value_format = "multiplier_percent", default_show = true },
    up_you_go = { skill_id = "up_you_go", skills_new = { 5, 7 }, category = "fugitive", default_show = false },
    running_from_death = { skill_id = "running_from_death", skills_new = { 5, 8 }, category = "fugitive", value_format = "multiplier_percent", default_show = true },
    ...
    grinder = { perks = { 4, 6 }, category = "perk", show_stack_count = true, default_show = true },
    sicario_dodge = { perks = { 1, 0 }, texture_bundle_folder = "max", category = "perk", value_format = "percent", default_show = true },
    smoke_screen_grenade = { perks = { 0, 0 }, texture_bundle_folder = "max", category = "perk", show_stack_count = true, default_show = true },
    biker = { perks = { 0, 0 }, texture_bundle_folder = "wild", category = "perk", stack_format = "biker_charges", default_show = true },
    maniac = { perks = { 0, 0 }, texture_bundle_folder = "coco", category = "perk", value_format = "negative_number_1", default_show = false },
    ...
    pocket_ecm_kill_dodge = { perks = { 3, 0 }, texture_bundle_folder = "joy", category = "perk", value_format = "percent", default_show = false },
    ...
    delayed_damage = { perks = { 3, 0 }, texture_bundle_folder = "myh", category = "perk", value_format = "negative_number", default_show = true },
    close_contact = { perks = { 5, 4 }, category = "perk", default_show = true },
    overdog = { perks = { 6, 4 }, category = "perk", default_show = false },
    melee_stack_damage = { perks = { 5, 4 }, category = "perk", value_format = "multiplier", show_stack_count = true, default_show = false },
    tooth_and_claw = { perks = { 0, 3 }, category = "perk", default_show = true },
    hostage_situation = { perks = { 0, 1 }, category = "perk", show_stack_count = true, default_show = false },
    yakuza = { perks = { 2, 7 }, category = "perk", value_format = "percent", default_show = false },

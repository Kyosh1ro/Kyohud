...
local Catalog = {
    ...
    definitions = {
        ...
        damage_increase = { hud_tweak = "equipment_chrome_mask", class = "BuffItemBase", priority = 2 },
        damage_reduction = { skills_new = { 10, 8 }, skill_id = "dire_need", class = "BuffItemBase", priority = 2 },

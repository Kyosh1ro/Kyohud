...
local Catalog = {
    ...
    definitions = {
        ...
        damage_increase = { hud_tweak = "equipment_chrome_mask", class = "BuffItemBase",
            priority = 2, state = "composite", value_kind = "final_multiplier",
            display_mode = "bonus_percent", composite_operation = "multiply", show_value = true },
        damage_reduction = { skills_new = { 10, 8 }, skill_id = "dire_need",
            class = "BuffItemBase", priority = 2, state = "composite",
            value_kind = "damage_taken_multiplier", display_mode = "reduction_percent",
            composite_operation = "multiply", show_value = true },
        melee_damage_increase = { skills_new = { 2, 8 }, skill_id = "hidden_blade",
            class = "BuffItemBase", priority = 2, state = "composite",
            value_kind = "final_multiplier", display_mode = "multiplier",
            composite_operation = "multiply", show_value = true,
            icon_provenance = "skilltree skill hidden_blade icon_xy" },
        total_dodge_chance = { hud_tweak = "pd2_generic_tickbox", class = "BuffItemBase",
            priority = 2, state = "composite", value_kind = "final_fraction",
            display_mode = "percent", composite_operation = "replace", show_value = true },
        equipped_perk_deck = { hud_tweak = "pd2_generic_tickbox", class = "BuffItemBase", priority = 1, ignore = true },
    },
    routes = {
        berserker = { "melee_damage_increase" },
        berserker_aced = { "berserker_aced", "damage_increase" },

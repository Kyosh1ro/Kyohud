...
-- Moved to lua/ky_buff_render.lua (cell rendering, progress tracking, state resolution)

-- Moved to lua/ky_buff_render.lua (exposed as KH.DrawTimedBuffProgress, etc.)

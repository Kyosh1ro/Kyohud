...
local EVENT_MEDAL_DEFINITIONS = {
    ...
    run = {
        id       = "ky_hud_event_medal_run",
        fallback = "Headcase",
        color    = Color(0.3, 0.86, 0.52),           -- vert
...
local EVENT_MEDAL_ORDER = {
    "first_strike", "grave", "low_hp", "reload", "run", "rope",
}
...
function KH:add_kill(enemy_name, score, contributes_to_combo, special_banner, special_enemy_kind, weapon_family, event_info)
    -- Consommé après la déduplication de RecordScoredKill, même HUD masqué.
